...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		bg = new FlxSprite().loadGraphic(Paths.image('menuDesatDef'));
		add(bg);
		bg.screenCenter();
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Vs Queen Mod Team'],
			['Not_Wingow',		'wingow',		'Project Leader, Musician and Artist',							'https://twitter.com/Wingow_',	'aa32fe'],
			['BoyZa',			'boyza',		'Charter',						'https://twitter.com/boyza___',		'ab67ab'],
			['Crimson',				'crimson',			'Programmer',					'https://twitter.com/TheCrimson_Dude',			'00baff'],
			[''],
			['Psych Engine Team'],
