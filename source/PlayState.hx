...
class PlayState extends MusicBeatState
{
	...
	public var deltaruneDialogue:DialogueBoxDeltarune;
	//You don't have to add a song, just saying. You can just do "startDialogue(dialogueJson);" and it should work
	public function startDialogue(dialogueFile:DialogueFile, ?deltaBox:Bool = false, ?song:String = null):Void
	{
		if (deltaBox)
			{
				inCutscene = true;
				...
				deltaruneDialogue = new DialogueBoxDeltarune(SONG.song.toLowerCase());
				deltaruneDialogue.scrollFactor.set();
				if(endingSong) {
					deltaruneDialogue.finishThing = function() {
						deltaruneDialogue = null;
						endSong();
					}
				} else {
					deltaruneDialogue.finishThing = function() {
				...
				deltaruneDialogue.nextDialogueThing = startNextDialogue;
				deltaruneDialogue.skipDialogueThing = skipDialogue;
				deltaruneDialogue.cameras = [camOther];
				add(deltaruneDialogue);
			}
			else 
